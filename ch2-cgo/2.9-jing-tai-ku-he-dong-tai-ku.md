...
## 2.9.1 使用C静态库 <a id="291-&#x4F7F;&#x7528;c&#x9759;&#x6001;&#x5E93;"></a>
...
## 2.9.2 使用C动态库 <a id="292-&#x4F7F;&#x7528;c&#x52A8;&#x6001;&#x5E93;"></a>
...
## 2.9.3 导出C静态库 <a id="293-&#x5BFC;&#x51FA;c&#x9759;&#x6001;&#x5E93;"></a>
...
## 2.9.4 导出C动态库 <a id="294-&#x5BFC;&#x51FA;c&#x52A8;&#x6001;&#x5E93;"></a>
...
## 2.9.5 导出非main包的函数 <a id="295-&#x5BFC;&#x51FA;&#x975E;main&#x5305;&#x7684;&#x51FD;&#x6570;"></a>
...
其中我们导入了number子包，在number子包中有导出的C函数number\_add\_mod，同时我们在main包也导出了goPrintln函数。
